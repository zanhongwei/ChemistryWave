...
public class MarqueeView extends ViewFlipper {
    ...
    private View createView(int position) {
        ...
        TextView ivMarquee = (TextView) view.findViewById(R.id.ivMarquee);
        TextView tvMarquee = (TextView) view.findViewById(R.id.tvMarquee);
        TextView ivMarquee2 = (TextView) view.findViewById(R.id.ivMarquee2);
        TextView tvMarquee2 = (TextView) view.findViewById(R.id.tvMarquee2);
...
//                    .into(ivMarquee);
//        }
        ivMarquee.setText(marquee.getFirstimgUrl());
        tvMarquee.setText(marquee.getFirsttitle());
        ivMarquee2.setText(marquee.getImgUrl());
        tvMarquee2.setText(marquee.getTitle());

...
import com.zhw.chemistrywave.utils.LogUtil;
import com.zhw.chemistrywave.utils.cache.DiskLruCache;
        ...
        synchronized (mDiskCacheLock) {
            ...
            try {
                if (mDiskCacheDir.exists() || mDiskCacheDir.mkdirs()) {
                    diskLruCache = DiskLruCache.open(mDiskCacheDir, MyApplication.VERSION_CODE, 1, mDiskCacheMaxSize);
                } else {

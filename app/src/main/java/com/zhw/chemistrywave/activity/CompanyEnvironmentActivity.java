...
public class CompanyEnvironmentActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitlebarCenter.setText("Environment Photos");
    ...
    private void getData() {
        ...
        try {
            ...
            jsonObject.put("env_type","office");
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        Log.e("aaa",
                                "(CompanyEnvironmentActivity.java:105)<--查询公司环境照片失败返回-->"+e.getMessage());
                    }

                    @Override
                    public void onResponse(String response, int id) {
                        Log.e("aaa",
                                "(CompanyEnvironmentActivity.java:111)<--查询公司环境照片成功返回-->"+response);
    ...
    @OnClick({R.id.rl_titlebar_back, R.id.btn_add,R.id.tv_titlebar_right})
    ...
    private void commit() {
        OkHttpUtils
                ...
                .addParams("environment_src",environmentStr)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        Log.e("aaa",
                                "(CompanyEnvironmentActivity.java:108)<--上传公司环境 失败返回-->"+e.getMessage());
                    }

                    @Override
                    public void onResponse(String response, int id) {
                        Log.e("aaa",
                                "(CompanyEnvironmentActivity.java:114)<--上传公司环境 成功返回-->"+response);
                        if (TextUtils.isEmpty(response)){
                            ToastUtil.showToastShort(CompanyEnvironmentActivity.this,"Network error");
                        }else {
                            try {
                                JSONObject jsonObject = new JSONObject(response);
                                String msg = jsonObject.getString("msg");
                                ToastUtil.showToastShort(CompanyEnvironmentActivity.this,msg);
        ...
        if (requestCode == PHOTO_REQUEST_GALLERY) {
            ...
            if (data != null) {
                try {
                    ...
                    ivEnvironment.setImageBitmap(bitmap1);
                    ZProgressHUD progressHUD = ZProgressHUD.getInstance(CompanyEnvironmentActivity.this);
                        ...
                        if (!TextUtils.isEmpty(response)) {
                            try {
                                ...
                                if (code == 0) {
                                    ...
                                    Toast.makeText(CompanyEnvironmentActivity.this, "the file upload failed", Toast.LENGTH_SHORT).show();
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }

...
public class PopLvPurityAdapter extends BaseAdapter {
    private Context mContext;
    private List<String> mList;
    private int currentPosition = 0;

    public PopLvPurityAdapter(Context mContext, List<String> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvPopYijifenlei.setText(mList.get(position));
